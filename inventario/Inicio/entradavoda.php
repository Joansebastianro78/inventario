            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Inventario Vodafone</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <a href="./excel.php" class ="btn-small blue"> <img src="../Inicio/estilos/img/excel.webp" width="40" height="40" >Exportar</a>
                            </div>
                        </div>
                        <div class="card mb-4">
                            ...
                            <input type="text" name ="buscar"id="buscar" placeholder="Buscar...">
                                ...
                                <?php 
                                    ...
                                    echo '<td><a class="btn btn-danger btn btn-primary mb-1 mb-md-0"" href="../procesar.php?id='. $entrada-> id .'">Salida</a></td>';
                                ?>
                                 
                                <td>
                                
                                 <!-- <button type="submit" class="btn btn-danger btn btn-primary mb-1 mb-md-0" >salida</button> -->
                                <!-- </form> -->
                                </td>
